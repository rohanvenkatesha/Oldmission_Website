...
<motion.div className="mt-6 flex flex-wrap justify-center gap-4">
  <a href="#services" className="self-start">
  ...
  <a href="#footer" className="self-start">
    <button className="px-8 py-4 bg-purple-600 text-white font-semibold rounded-xl shadow-lg hover:bg-purple-700 transition-all duration-300 transform hover:scale-105 self-start flex items-center justify-center">
      REQUEST MORE INFO
    </button>
  </a>
</motion.div>
